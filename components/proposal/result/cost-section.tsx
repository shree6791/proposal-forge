      ...
      <div className="bg-gray-50 rounded-xl p-4">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">All prices exclude VAT and local taxes</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 bg-purple-600 rounded-full" />
            <span className="text-sm text-gray-600">Year 2 and 3 pricing valid with 3-year contract</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 bg-pink-600 rounded-full" />
            <span className="text-sm text-gray-600">Includes productivity improvements over time</span>
          </div>
        </div>
      </div>
    </motion.div>
